...
run_test_args "slow" "16 16 20 10 20 5 3 2" "Enter sequence of integers, each followed by a space: Number of inversions: 21"
run_test_args "slow" "7" "Enter sequence of integers, each followed by a space: Number of inversions: 0"
run_test_args "slow" "$(seq -s " " 1 10000)" "Enter sequence of integers, each followed by a space: Number of inversions: 0"
run_test_args "slow" "$(seq -s " " 10000 -1 1)" "Enter sequence of integers, each followed by a space: Number of inversions: 49995000"
run_test_args "slow" "1 2 3 2 1" "Enter sequence of integers, each followed by a space: Number of inversions: 4"
run_test_args "slow" "0 10 20 30 2 2 2 2 2" "Enter sequence of integers, each followed by a space: Number of inversions: 15"
run_test_args "slow" "50000" "Enter sequence of integers, each followed by a space: Number of inversions: 0"
...
run_test_args "" "16 16 20 10 20 5 3 2" "Enter sequence of integers, each followed by a space: Number of inversions: 21"
run_test_args "" "7" "Enter sequence of integers, each followed by a space: Number of inversions: 0"
run_test_args "" "$(seq -s " " 1 10000)" "Enter sequence of integers, each followed by a space: Number of inversions: 0"
run_test_args "" "$(seq -s " " 10000 -1 1)" "Enter sequence of integers, each followed by a space: Number of inversions: 49995000"
run_test_args "" "1 2 3 2 1" "Enter sequence of integers, each followed by a space: Number of inversions: 4"
run_test_args "" "0 10 20 30 2 2 2 2 2" "Enter sequence of integers, each followed by a space: Number of inversions: 15"
run_test_args "" "50000" "Enter sequence of integers, each followed by a space: Number of inversions: 0"
